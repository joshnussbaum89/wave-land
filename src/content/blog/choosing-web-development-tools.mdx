...
image: './images/web-development-tools.jpg'
imageAlt: 'Two computer monitors with code on the screen on a desk with headphones.'
socialImage: '/images/web-development-tools.jpg'
layout: '../../layouts/BlogLayout.astro'
---

import { Picture } from 'astro:assets'
import Link from '../../components/text/Link.astro'
import headerImage from './images/web-development-tools.jpg'
...
<header>
  <div class="header-info">
    <h1>Choosing Web Development Tools</h1>
    <p>
      <em>
    ...
    <Picture
      src={headerImage}
      formats={['avif', 'webp']}
      alt="Two computer monitors with code on the screen on a desk with headphones."
      loading="eager"
    />
  </div>
</header>
...
{/* TEMPORARILY REMOVED see: https://docs.astro.build/en/reference/errors/unsupported-image-format/ */}
{/* <Picture class="small" src={johnSnowImage} alt="John Snow" /> */}
