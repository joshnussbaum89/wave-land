...
<Link
  ...
  text="Lazy-load"
  newWindow={true}
/> images and videos until a user interacts with the element and avoid auto-playing videos if you can
help it.
...
I've <Link href="https://wavelandweb.com/blog/choosing-web-development-tools/" text="written" /> about this previously, and it's an area that I'm passionate about.
...
Think we're a good fit for your next website? Reach out <Link href="/contact" text="here" /> for a complimentary 1:1 brainstorming session to learn about all the ways we can help.
